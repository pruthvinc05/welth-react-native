...
export default function HomeScreen() {
    ...
    const { data: transactions = [],
        ...
        isRefetching: transactionstRefetching,
    ...
    const refreshing = accountsRefetching || transactionstRefetching
                    ...
                    <View className='flex-row gap-2.5'>
                        {QUICK_ACTIONS.map((action) => (
                            ...
                            >
                                ...
                                <Text className='text-[#BBBAC2] text-[11px] font-medium text-center'>
                                    {action.label}
                                </Text>
                            </TouchableOpacity>
                        ))}
                                ...
                                <View className='h-2 rounded-full bg-[#F0EEE7] overflow-hidden'>
                                    <View
                                        ...
                                        style={{
                                            ...
                                            backgroundColor: monthExpense >= budget.amount
                                                ? "#FF6B4A"
