            ...
            >
                <View className='flex-1 justify-center px-6 -mt-16'>
                    <Image
                        ...
                        resizeMode='contain'
                    />
                    <Text className='text-3xl font-bold text-[#1A1D26] mb-1 leading-tight'>
                        Verify your account
                    </Text>
                    ...
                    <Controller
                        ...
                        render={({ field: { value, onChange } }) => {
                            return (
                                <TextInput
                                    className='border border-[#E8E6DF] bg-white rounded-xl px-4 py-3 mb-3 text-[#1A1D26]'
                    ...
                    <TouchableOpacity
                        className='w-full bg-brand-blue py-4 rounded-xl items-center mb-3'
                        disabled={isLoading}
    ...
    return (
        ...
        >
            <View className='flex-1 justify-center px-6 -mt-16'>
                ...
                <View className={`flex-row gap-3 ${(formErrors.firstName || formErrors.lastName) ? "mb-0" : "mb-3"}`}>
                    <Controller
                        control={control}
                        name='firstName'
                        render={({ field: { value, onChange } }) => {
                ...
                <Controller
                    ...
                    render={({ field: { value, onChange } }) => {
                        return (
                            <TextInput
                                className={`border border-[#E8E6DF] bg-white rounded-xl px-4 py-3 ${formErrors.email || errors.fields.emailAddress ? "mb-0" : "mb-3"} text-[#1A1D26]`}
                ...
                <Controller
                    ...
                    render={({ field: { value, onChange } }) => {
                        return (
                            <View
                                className={`flex-row items-center border border-[#E8E6DF] bg-white rounded-xl px-4 ${formErrors.password || errors.fields.password ? "mb-0" : "mb-3"
                                    }`}
                            >
                                <TextInput
                                    className="flex-1 py-3 text-[#1A1D26]"
